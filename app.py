...
# ── Required: patch cross-attention ──────────────────────────────────────────
...
# ── Vocab class (required for pickle to deserialize saved vocabs) ─────────────
class Vocab:
...
def load_pipeline():
    ...
    with open(save_dir / 'src_vocab.pkl', 'rb') as f:
        sv = pickle.load(f)
    with open(save_dir / 'tgt_vocab.pkl', 'rb') as f:
        tv = pickle.load(f)
